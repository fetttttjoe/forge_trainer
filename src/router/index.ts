...
const routes: RouteRecordRaw[] = [
  ...
  { path: paths.plan(':id'), name: RouteName.Plan, component: () => import('@/views/PlanBuilderView.vue'), props: true },
  { path: paths.pick(':id', ':dayId'), name: RouteName.Pick, component: () => import('@/views/PickerView.vue'), props: true },
  { path: paths.exercise(':id'), name: RouteName.Exercise, component: () => import('@/views/ExerciseDetailView.vue'), props: true },
  { path: paths.addToPlan(':id'), name: RouteName.AddToPlan, component: () => import('@/views/AddToPlanView.vue'), props: true },
  ...
  { path: paths.session(':id'), name: RouteName.Session, component: () => import('@/views/SessionDetailView.vue'), props: true },
  { path: paths.planned(':planId', ':dayId'), name: RouteName.Planned, component: () => import('@/views/PlannedDayView.vue'), props: true },
