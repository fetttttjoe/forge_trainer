...
export const BUILTIN: Exercise[] = [
  {
    ...
    icon: '🦵',
    instructions:
      'Brace hard, sit down and back until hips pass parallel, then drive through mid-foot. Keep the bar over your mid-foot the whole way.',
  },
  {
    id: 'deadlift',
    name: 'Deadlift',
    ...
    icon: '🏋️',
    instructions:
      'Hips back, flat spine, take the slack out of the bar, then push the floor away. Lock out with glutes.',
  },
  {
    id: 'bench',
    name: 'Bench Press',
    ...
    icon: '💪',
    instructions:
      'Retract shoulder blades, small arch, bar to lower chest, elbows ~45°. Press up and slightly back over the shoulders.',
  },
  {
    id: 'ohp',
    name: 'Overhead Press',
    ...
    icon: '🙆',
    instructions:
      'Squeeze glutes, brace, press the bar straight up while moving your head back then through. Finish with biceps by ears.',
  },
  {
    id: 'wpull',
    ...
    icon: '🧗',
    instructions:
      'Full dead hang, pull elbows down and back until chin clears the bar. Control the lower — no kipping.',
  },
  {
    id: 'row',
    name: 'Dumbbell Row',
    ...
    groups: ['back'],
    icon: '🚣',
    instructions: 'Hinge, flat back, pull the dumbbell to your hip, squeeze the lat, lower under control.',
  },
  {
    id: 'curl',
    name: 'Barbell Curl',
    ...
    icon: '💪',
    instructions:
      'Elbows pinned to sides, curl without swinging, squeeze at the top, lower slowly for the full stretch.',
  },
  {
    id: 'face',
    name: 'Face Pull',
    ...
    icon: '🎯',
    instructions:
      'Pull the rope to your forehead, elbows high, externally rotate at the end. Great for shoulder health.',
  },
  {
    id: 'rdl',
    ...
    icon: '🦵',
    instructions:
      'Soft knees, push hips back, slide the bar down the thighs until you feel a deep hamstring stretch, then drive hips forward.',
  },
  {
    id: 'plank',
    name: 'Plank',
    ...
    groups: ['core'],
    icon: '🧘',
    instructions: 'Elbows under shoulders, ribs down, glutes tight, straight line from head to heels. Breathe.',
  },
  {
    id: 'hang',
    ...
    rounds: 6,
    icon: '🧗',
    instructions: '20 mm edge, half-crimp. Hang 7 s, rest 3 s, repeat ×6 for one set. Rest 2–3 min between sets.',
  },
  {
    id: 'campus',
    ...
    rounds: 5,
    icon: '🪜',
    instructions: 'Explosive ladder moves (1-3-5). Quality over volume — stop the moment power or precision drops.',
  },
]
...
export function seedHistory(now = Date.now()): HistorySession[] {
  ...
  const bench = (w: number): [string, Row[]] => [
    'bench',
    [
      [w, 8, 1],
      [w, 8, 1],
  ...
  return [
    S(1, 'Full Body 3×', 'Legs', true, 4, 'solid', 52, [
      [
        'squat',
        [
          [95, 5, 1],
    ...
    S(2, 'Climb Strong', 'Fingers & Pull', false, 3, 'grindy', 38, [
      [
        'hang',
        [
          [0, 6, 1],
    ...
    S(4, 'Full Body 3×', 'Push', true, 5, 'solid', 49, [
      [
        'bench',
        [
          [72.5, 5, 1],
    ...
    S(6, 'Climb Strong', 'Fingers & Pull', true, 4, 'solid', 44, [
      [
        'hang',
        [
          [0, 6, 1],
    ...
    S(9, 'Full Body 3×', 'Push', true, 4, 'solid', 47, [
      bench(70),
      [
        'ohp',
        [
    ...
    S(13, 'Full Body 3×', 'Legs', true, 4, 'solid', 55, [
      [
        'squat',
        [
          [90, 6, 1],
    ...
    S(18, 'Full Body 3×', 'Push', true, 4, 'solid', 46, [
      bench(67.5),
      [
        'face',
        [
    ...
    S(25, 'Full Body 3×', 'Push', false, 3, 'grindy', 40, [
      [
        'bench',
        [
          [65, 8, 1],
    ...
    S(32, 'Climb Strong', 'Fingers & Pull', true, 5, 'solid', 43, [
      [
        'hang',
        [
          [0, 6, 1],
    ...
    S(46, 'Full Body 3×', 'Push', true, 4, 'solid', 44, [
      bench(60),
      [
        'ohp',
        [
