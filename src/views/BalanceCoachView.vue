...
<template>
  <div class="flex h-[100dvh] flex-col bg-bg text-ink">
    ...
    <div class="flex-1 overflow-y-auto px-5 pb-6 pt-[6px]">
      <div
        class="flex items-center gap-3 rounded-[16px] border-[1.5px] border-dashed border-[color-mix(in_srgb,var(--accent)_35%,transparent)] bg-[color-mix(in_srgb,var(--accent)_9%,transparent)] px-[15px] py-[14px]"
      >
      ...
      <div class="mt-4 rounded-[16px] border border-line bg-surface p-4 shadow-card">
        ...
        <div class="mt-[6px] text-[13px] text-ink-2">
          Suggestion: add a legs day, or swap one pull session. Keeps you climbing without a weak base.
        </div>
      ...
      <div class="mt-3 rounded-[16px] border border-line bg-surface p-4 shadow-card">
        ...
        <div class="mt-[6px] text-[13px] text-ink-2">
          Suggestion: drop to a 6 s hang or add 2 s rest, then rebuild. We'll watch the rating recover.
        </div>
      </div>

      <div class="mt-3 rounded-[16px] bg-ink p-4 text-bg">
        <div class="mb-2 flex items-center gap-2">
          <span class="text-[15px]">✨</span><span class="text-[13px] font-extrabold">AI coach — later</span>
        </div>
        <div class="text-[13px] leading-[1.55] opacity-70">
          With enough logged sets and ratings, Forge can propose full plan adjustments. The data model is built for it
          today — the feature ships when the offline core is rock-solid.
        </div>
      </div>
    </div>
  </div>
